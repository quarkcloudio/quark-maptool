...
// 关闭任务，OpenTask() | OpenTask("开启任务")
func OpenTask(options ...interface{}) *OpenTaskAction {
	action := &OpenTaskAction{}
...
// 初始化
func (p *OpenTaskAction) Init(ctx *quark.Context) interface{} {
...
// 执行行为句柄
func (p *OpenTaskAction) Handle(ctx *quark.Context, query *gorm.DB) error {
	// 设置任务状态
